...
import { filterBlogsByLanguage, convertPathToUrl } from '@/lib/language-utils'
    ...
    <>
      <div>
        <div className="pt-6 pb-6">
          <h1
            className="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:hidden sm:text-4xl sm:leading-10 md:text-6xl md:leading-14 dark:text-gray-100"
                  ...
                  return (
                    <li key={t} className="my-3">
                      {decodeURI(pathname.split('/tags/')[1]) === slug(t) ? (
                        <h3
                          className="text-primary-500 inline px-3 py-2 text-sm font-bold uppercase"
                          style={{ fontFamily: 'var(--font-dunkin-sans-bold)' }}
                        >
                          {`${t} (${tagCounts[t]})`}
                        </h3>
